		...
		csvStream = csv.parse()
			...
			else 
			{
			  if(validated)	{
			    ...
			    // else {                                   // for error responsive
					// if(data[0]=='')responseMap.set(data[3],"data/time is not given");
					// else if(data[1]=='')responseMap.set(data[3],"settlement id is not given");
					// else if(data[2]=='')responseMap.set(data[3],"type is not given")
				// }
